...
{
    /// <inheritdoc />
    public partial class InicialConfi : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    telNumClientes = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    codBarras = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    codProveedor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventario_Proveedor_ProveedorcodProveedor",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventario_ProveedorcodProveedor",
                table: "Inventario",
